...
var opts = require("commander")
  ...
  .option('--debug', 'Print each filename being prased.')
  .option('--keys [keys]', 'JSON keys (comma separated) to use when extracting messages.', optAsList)
  .option('--ignore-keys [keys]', 'JSON keys to exclude when extracting messages.', optAsList)
  .parse(process.argv);
